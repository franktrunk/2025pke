...
#define IRQ_S_EXT 9                 // s-mode external interrupt s模式外部中断
#define IRQ_S_TIMER 5               // s-mode timer interrupt    s模式定时器中断  
#define IRQ_S_SOFT 1                // s-mode software interrupt  s模式软件中断 
#define IRQ_M_SOFT 3                // m-mode software interrupt  m模式软件中断

// mip 寄存器的字段，表示机器中断挂起寄存器
...
#define PMP_A 0x18  //地址对齐权限
#define PMP_L 0x80  //锁定权限
#define PMP_SHIFT 2 //位移

#define PMP_TOR 0x08 //透明区域
#define PMP_NA4 0x10 //非对齐4字节访问
#define PMP_NAPOT 0x18 //非对齐页面
